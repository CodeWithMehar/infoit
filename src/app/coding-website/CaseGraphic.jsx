...
export default function CaseGraphic() {
  return (
    ...
    <div className="w-full lg:w-[60%] flex flex-col md:flex-row space-y-6 md:space-y-0 md:space-x-6">
      ...
      <CaseCard 
        ...
        imageUrl="https://cdn.pixabay.com/photo/2015/09/09/20/40/drawing-933207_1280.jpg"
      />
      {/* Card 2 */}
      <CaseCard 
        title="HVAC SERVICE COMPANY"
        subtitle="+349% Keywords Ranked in Top 5"
        imageUrl="https://img.freepik.com/premium-photo/graphic-designer-concept-illustration_1155130-2169.jpg?semt=ais_hybrid"
      />
      {/* Card 3 */}
      <CaseCard 
        title="ECOMMERCE BUSINESS"
        subtitle="+70% Website Traffic"
        imageUrl="https://img.freepik.com/premium-photo/graphic-designer-concept-illustration_1155130-2332.jpg?semt=ais_hybrid"
      />
    </div>
  </div>
  )
