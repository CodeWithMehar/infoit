...
export default function FirstCoding() {
  return (
    <div className="relative w-full pt-28 pb-36 flex items-center justify-center bg-white">
      ...
      <div className="absolute inset-0 flex items-center justify-center hidden sm:flex">
        <span className="font-calibri italic text-[100px] md:text-[200px] lg:text-[250px] font-bold opacity-10 animate-ping select-none">
          STEPS
        </span>
      </div>
      ...
      <div className="relative z-10 text-center text-gray-900 flex flex-wrap justify-center items-center">
        {/* Card 1 */}
        <StepCard step={1} title="Research" icon={<HiLightBulb />} />
        ...
        <PiArrowArcRightBold className="text-[60px] text-[#7d963d] " />
        {/* Card 3 */}
        <StepCard step={3} title="Design" icon={<SiVorondesign />} />
        <PiArrowArcRightBold className="text-[60px] text-[#7d963d] " />
        {/* Card 4 */}
        <StepCard step={4} title="Development" icon={<CgWebsite />} />
        <PiArrowArcRightBold className="text-[60px] text-[#7d963d] " />
        {/* Card 5 */}
        <StepCard step={5} title="Launch" icon={<IoRocketOutline />} />
      </div>
    </div>
  );
}
