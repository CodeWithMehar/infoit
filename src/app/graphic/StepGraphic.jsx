  ...
  return (
   <>
      ...
      <div className="relative z-10 text-center text-gray-900 flex flex-wrap justify-center items-center">
        {/* Card 1 */}
        <StepCard step={1} title="Discovery" icon={<AiOutlineFileSearch />} />
        <PiArrowArcRightBold className="text-[60px] text-[#7d963d] " />
        {/* Card 2 */}
        <StepCard step={2} title="Development" icon={<PiBuildingApartmentThin />} />
        <PiArrowArcRightBold className="text-[60px] text-[#7d963d] " />
        {/* Card 3 */}
        <StepCard step={3} title="Design" icon={<SiVorondesign />} />
        <PiArrowArcRightBold className="text-[60px] text-[#7d963d] " />
        {/* Card 4 */}
        <StepCard step={4} title="Revisions" icon={<CgWebsite />} />
        <PiArrowArcRightBold className="text-[60px] text-[#7d963d] " />
        {/* Card 5 */}
        <StepCard step={5} title="Delivery" icon={<CiLink />} />
      </div>
    </div>
   </>
  )
