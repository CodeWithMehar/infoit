...
import CaseGraphic from "../coding-website/CaseGraphic";
      ...
      >
        ...
        <div className="relative flex flex-col md:flex-row items-center justify-center h-full w-full text-white text-3xl font-bold px-5 md:px-20 pt-10 md:pt-20 space-y-8 md:space-y-0">
          ...
          {/* <img
            ...
            <h1 className="text-[40px] md:text-[70px] leading-[70px] capitalize text-center md:text-left font-calibri italic">
              Transform <br /> Ideas into Designs
            </h1>
