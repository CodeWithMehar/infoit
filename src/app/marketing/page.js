...
import ScrollMarket from "./ScrollMarket";
...
export default function page() {
  ...
  return <>
     <div
        ...
        style={{
          backgroundImage:
            'url("https://img.freepik.com/premium-photo/corporate-management-strategy-solution-branding-concept_1269531-4.jpg?ga=GA1.1.1042070903.1730462170&semt=ais_hybrid")',
        }}
      >
        {/* Black Overlay */}
        ...
        <div className="relative flex flex-col md:flex-row items-center justify-center h-full w-full text-white text-3xl font-bold px-5 md:px-20 pt-10 md:pt-20 space-y-8 md:space-y-0">
          ...
          {/* <img
              src={star.src}
              className="absolute left-[60%] bottom-[70%] h-[170px] w-[170px] slow-spin"
              alt="Spinning Shape"
            />
               <img
              src={logo.src}
              className="w-[50px] h-[50px] absolute left-[71%] bottom-[89%]"
            /> */}

            <h1 className="font-calibri italic text-[40px] md:text-[70px] leading-[70px] capitalize text-center md:text-left">
            Boost Your <br/> Online Presence
            </h1>
