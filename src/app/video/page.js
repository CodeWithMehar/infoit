...
export default function page() {
  ...
  <>
   <div
        ...
        style={{
          backgroundImage:
            'url("https://img.freepik.com/free-photo/video-editor-editing-audio-film-montage-with-post-production-software-computer-videographer-working-movie-footage-edit-with-color-grading-visual-sound-effects-home_482257-49858.jpg?ga=GA1.1.1042070903.1730462170&semt=ais_hybrid")',
        }}
      >
        {/* Black Overlay */}
        ...
        <div className="relative flex flex-col md:flex-row items-center justify-center h-full w-full text-white text-3xl font-bold px-5 md:px-20 pt-10 md:pt-20 space-y-8 md:space-y-0">
          ...
          {/* <img
            ...
            />
               <img
              src={logo.src}
              className="w-[50px] h-[50px] absolute left-[73%] bottom-[91%]"
            /> */}

            <h1 className="text-[40px] md:text-[70px] leading-[80px] capitalize text-center md:text-left font-calibri italic">
            Engaging <br/> Visual Storytelling
            </h1>
            <p className=" md:text-[20px] text-gray-400 leading-normal mt-3 md:mt-5 text-center md:text-left font-gabriola text-[20px]">
          ...
          <div className="w-full md:w-1/2 flex justify-center md:justify-end">
            <img
              ...
              src="https://img.freepik.com/free-photo/video-editor-editing-audio-film-montage-with-post-production-software-computer-videographer-working-movie-footage-edit-with-color-grading-visual-sound-effects-home_482257-49858.jpg?ga=GA1.1.1042070903.1730462170&semt=ais_hybrid"
