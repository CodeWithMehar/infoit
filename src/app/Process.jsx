...
export default function Process() {
  ...
  alt="Decorative ring"
  className="absolute left-[40%] top-[20%] animate-ping"
  width={ring.width}     // agar ring object me width/height hai to use karo
  height={ring.height}
/>
      {/* Header Section */}
...
/>
      ...
      <div className="flex flex-wrap justify-center items-center min-h-screen gap-8 md:gap-10 relative">
        ...
        <ProcessItem
          ...
          imgSrc={text1.src}
          iconSrc="https://cdn-icons-gif.flaticon.com/17556/17556530.gif"
        />
        <ProcessItem
          title="UI/UX Design"
          description="Focuses on the look and feel of the product."
          imgSrc={text2.src}
          iconSrc="https://cdn-icons-gif.flaticon.com/6454/6454225.gif"
        />
        <ProcessItem
          title="Prototype"
          description="A prototype is an early sample or model."
          imgSrc={text3.src}
          iconSrc="https://cdn-icons-gif.flaticon.com/17907/17907834.gif"
        />
        <ProcessItem
          title="Development"
          description="Development is the process of building the actual product."
          imgSrc={text4.src}
          iconSrc="https://cdn-icons-gif.flaticon.com/15712/15712980.gif"
        />
      </div>
    </div>
  );
...
function ProcessItem({ title, description, imgSrc, iconSrc }) {
  ...
  src={iconSrc}
  alt={`${title} icon`}
  width={50}  // ya jitna size chahiye us hisaab se
  height={50}
  className="w-1/2 h-1/2"  // Tailwind classes agar chahiye
/>
      </div>
  ...
  src={imgSrc}
  alt={`${title} illustration`}
  width={70}  // max width for md screen size
  height={70} // max height for md screen size
  className="w-[60px] h-[60px] md:w-[70px] md:h-[70px]"
/>
      </div>
