      ...
      <div className="w-full container mx-auto px-5 md:px-10 flex flex-col md:flex-row space-y-10 md:space-y-0 md:space-x-10 overflow-hidden">
        ...
        >
          ...
          <p className="font-gabriola text-gray-700 py-5 capitalize text-[30px] md:text-2xl text-justify">
            ...
            comprehensive services. Located in Jodhpur, we specialize in Digital
            Marketing in Udaipur, Web Development, App Development Services, SEO
            Services In Udaipur, and Website Development. Our expert team of
            Website Developers In Udaipur is dedicated to helping you rank your
            Google Ads and improve your Google ranking.
          </p>
        </MotionDiv>
          ...
          >
            ...
            <div className="relative group cursor-pointer">
              <Image
                ...
                height={853} // approximate height maintaining aspect ratio
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <p className="text-white text-[20px] md:text-[25px] font-semibold font-calibri">
                  OUR VISION
                </p>
              </div>
            </div>
            ...
            <div className="relative group cursor-pointer">
              <Image
                ...
                alt="Our Mission"
                width={1200} // approximate width of the image
                height={800} // approximate height maintaining aspect ratio
                className="w-full h-auto transition-all duration-500 object-cover"
              />
              <div className="absolute inset-0 bg-[#53666F] opacity-80 group-hover:opacity-0 transition-opacity duration-700"></div>
              <div className="absolute inset-0 flex items-center justify-center">
          ...
          >
            ...
            <div className="relative group cursor-pointer">
              <Image
                ...
                alt="Our Philosophy"
                width={612} // yahan image ki asli width
                height={612} // yahan image ki asli height
                className="w-full h-auto transition-all duration-500 object-cover"
              />
              <div className="absolute inset-0 bg-[#53666F] opacity-80 group-hover:opacity-0 transition-opacity duration-700"></div>
              <div className="absolute inset-0 flex items-center justify-center">
                <p className="text-white text-[20px] md:text-[20px] font-semibold font-calibri">
                  OUR PHILOSOPHY
                </p>
              </div>
            </div>
            ...
            <div className="relative group cursor-pointer">
              <Image
                src="https://cdn.pixabay.com/photo/2016/09/22/10/39/puzzle-1686920_1280.jpg"
                alt="Our Strategy"
                width={1280} // asli width of image
                height={853} // asli height of image (approximate ratio)
                className="w-full h-auto transition-all duration-500 object-cover"
              />
              <div className="absolute inset-0 bg-[#53666F] opacity-80 group-hover:opacity-0 transition-opacity duration-700"></div>
              <div className="absolute inset-0 flex items-center justify-center">
                <p className="text-white text-[20px] md:text-[25px] font-semibold uppercase font-calibri">
                  OUR STRATEGY
                </p>
              </div>
            </div>
